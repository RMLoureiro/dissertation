...
\nttitle(main,en){Reasoning about consensus protocols:}%
\nttitle(main,pt){Um Título de Tese Longo\\e com uma Mudança de Linha Forçada}%

%         You may use "\\" to force line breaks
\nttitle(sub,en){simulation and validation environment}%
...
%-------------------------------------------------------------------
\ntdepartment*(pt){Departamento de\\Departamento de Informática}
...
%-------------------------------------------------------------------
\ntauthorname(m){Ricardo Filipe Mendes Loureiro}{Ricardo Loureiro}
...
\ntauthordegree(pt){Mestrado em Mestrado em Engenharia Informática}
...
%         It <month> is a number, it it will be converted to the
%                  month name in the cover language.
%-------------------------------------------------------------------
% \ntdate{year-month-day}
\ntdate{2025-September}
% \ntdate{year}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){António Ravara, Associate Professor, NOVA University Lisbon}
% Co-advisers(s)
\ntaddperson{adviser}(c,m){Simão Melo de Sousa, Cathedradic Professor, University of Algarve}
