...
%                               %       iscteiul/eta, ips/ests, ipl/isel
...
% \ntsetup{lang/extra={de,es}}   % List of aditional languages are used in the document
...
% \ntsetup{print/webography=print/webography} % Generate a separate bibliography for @online references
...
% \ntsetup{style/chapter=bar}   % The chapter style to be used
...
% \ntsetup{debug={cover}}       % Cover development and debug: print rulers in the cover page
%                               % DEFAULT: debug={}
